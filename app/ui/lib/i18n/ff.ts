...
export const ff: Translations = {
  ...
  auth: {
    ...
    enterPin: "Naatnu kode PIN maa",
    createPin: "Sos kode PIN limɗe 4",
    confirmPin: "Tabintinu kode PIN maa",
    pinMismatch: "Kode PIN ɗiɗi ɗii nanondiraa",
    invalidPin: "Kode PIN moƴƴaa",
    accountLocked: "Konte maa uddaama. Fuɗɗito caggal",
    phoneTaken: "Tonngoode ndee huutoraama kisa",
    tooManyAttempts: "Ƴeewtagol keewii. Fuɗɗito caggal.",
    logout: "Yaltu",
    tryDemo: "Ƴeewto demo",
    demoMode: "Fannu demo",
  },
  ...
  pwa: {
    ...
    dismiss: "Wonaa jooni",
    updateAvailable: "Hesɗitine ena",
    updateDescription: "Fuɗɗito ngam heɓde moƴƴinaari",
    update: "Hesɗitin",
  },
  offline: {
    title: "Alaa ceŋol",
    message: "Alaa ceŋol enternet. Keɓe maa mooftaama e telefon maa.",
  },
};
