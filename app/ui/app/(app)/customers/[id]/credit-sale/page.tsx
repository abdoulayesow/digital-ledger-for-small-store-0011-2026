...
export default function RecordCreditSalePage() {
  ...
  async function handleConfirm() {
    ...
    setError(null);
    try {
      await recordCreditSale(retailerId, customerId, selectedAmount, note.trim() || null);
  ...
  if (done) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen gap-4 px-6">
        ...
        <p className="text-lg font-semibold text-text-primary">{t.sales.creditSaleRecorded}</p>
  ...
  return (
    <div className="flex flex-col">
      <PageHeader title={t.sales.addCreditSale} showBack />
